            ...
            <div className="fixed inset-0 z-[70] flex items-center justify-center p-4">
                ...
                >
                    ...
                    <div className="absolute inset-0 rounded-[3rem] overflow-hidden z-0 border border-white/20 shadow-2xl bg-black/90 backdrop-blur-xl">
                        <div className="absolute inset-0 scale-110 blur-lg opacity-40"> {/* BLURRED PATTERN INSIDE */}
                    ...
                    <motion.div 
                        ...
                        className="w-20 h-20 bg-[#00B2FF] rounded-full mx-auto mb-6 flex items-center justify-center shadow-[0_0_30px_rgba(0,178,255,0.6)] relative z-10"
                    >
                        <CheckCircle2 className="w-10 h-10 text-white stroke-[3] relative z-20" />
                    </motion.div>
                    ...
                    <div className="bg-black/40 rounded-[2rem] p-4 border border-white/5 mb-8 flex flex-col items-center relative z-10">
